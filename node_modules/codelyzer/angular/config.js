...
exports.Config = {
    ...
    predefinedDirectives: [
        ...
        { selector: '[md-header-item], [mat-header-item]', exportAs: 'mdMenuItem' },
        { selector: 'md-header, mat-header', exportAs: 'mdMenu' },
        { selector: 'md-button-toggle-group:not([multiple])', exportAs: 'mdButtonToggleGroup' },
        { selector: '[md-header-trigger-for], [mat-header-trigger-for], [mdMenuTriggerFor]', exportAs: 'mdMenuTrigger' },
